...
def main():
    ...
    total += ((3 * 9) * 10)  # once for each set of 10 numbers (except for 11), up to 100. then repeat for each set of 100
    ...
    total += ((3 * 9) * 10)  # once for each set of 10 numbers (except for 12), up to 100. then repeat for each set of 100
    total += (3 * 100)  # once for each number that starts with "two hundred" (200-299)

    # for each 3 found, add another 5 characters
    total += ((5 * 9) * 10)  # once for each set of 10 numbers (except for 13), up to 100. then repeat for each set of 100
    total += (5 * 100)  # once for each number that starts with "three hundred" (300-399)

    # for each 4 found, add another 4 characters
    total += ((4 * 9) * 10)  # once for each set of 10 numbers (except for 14), up to 100. then repeat for each set of 100
    total += (4 * 100)  # once for each number that starts with "four hundred" (400-499)

    # for each 5 found, add another 4 characters
    total += ((4 * 9) * 10)  # once for each set of 10 numbers (except for 15), up to 100. then repeat for each set of 100
    ...
    total += ((3 * 9) * 10)  # once for each set of 10 numbers (except for 16), up to 100. then repeat for each set of 100
    total += (3 * 100)  # once for each number that starts with "six hundred" (600-699)

    # for each 7 found, add another 5 characters
    total += ((5 * 9) * 10)  # once for each set of 10 numbers (except for 17), up to 100. then repeat for each set of 100
    total += (5 * 100)  # once for each number that starts with "seven hundred" (700-799)

    # for each 8 found, add another 5 characters
    total += ((5 * 9) * 10)  # once for each set of 10 numbers (except for 18), up to 100. then repeat for each set of 100
    total += (5 * 100)  # once for each number that starts with "eight hundred" (800-899)

    # for each 9 found, add another 4 characters
    total += ((4 * 9) * 10)  # once for each set of 10 numbers (except for 19), up to 100. then repeat for each set of 100
